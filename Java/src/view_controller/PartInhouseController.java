 ...
 */
public class PartInhouseController implements Initializable {
    ...
    void handleOutsourcedRadio(ActionEvent event) throws IOException {
        ...
        Parent partsCancel = FXMLLoader.load(getClass().getResource("PartOutsourced.fxml"));
            Scene scene = new Scene(partsCancel);
    ...
    void handleSavePartButton(ActionEvent event) throws IOException {
        ...
        String partMachineId = partMachineIdField.getText();
        ...
        newPart.setPartMachineId(Integer.parseInt(partMachineId));
